...
import { FormControl, RadioGroup, FormControlLabel, Radio, Card, Grid, TextField , CardContent, Typography, Button } from '@material-ui/core';
            ...
            {firstVoteCandidates.length > 0 && (
                <Card className="vote-section">
                    <CardContent>
                        ...
                        <RadioGroup name="firstVoteCandidates" value={selectedFirstVote} onChange={handleFirstVoteChange}>
            ...
            {secondVoteCandidates.length > 0 && (
                <Card className="vote-section">
                    <CardContent>
                        ...
                        <RadioGroup name="secondVoteCandidates" value={selectedSecondVote} onChange={handleSecondVoteChange}>
