with candidatevotes_ AS (SELECT erste_stimmzettel."StimmkreisId",
     ...
     CandidateVotes_ranked_pro_stimmkreis as (SELECT kgs."StimmkreisId",
                                                     kgs."ParteiID",
                                                     kgs."KandidatID",
                                                     kgs.stimmenzahl,
                                                     ROW_NUMBER() OVER (
     ...
     VictoryMargins AS (SELECT cv."StimmkreisId",
                               cv."ParteiID",
                               cv."KandidatID",
                               cv.stimmenzahl,
     ...
     TopNarrowestVictories AS (SELECT vm."ParteiID",
                                      vm."StimmkreisId",
                                      vm."KandidatID",
                                      vm.stimmenzahl,
                                      vm.relative_margin,
     ...
     top_ten_winners_id as (SELECT tnv."ParteiID",
                                   tnv."StimmkreisId",
                                   tnv."KandidatID",
                                   tnv.stimmenzahl,
                                   tnv.relative_margin,
