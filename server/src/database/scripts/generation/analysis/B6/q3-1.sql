...
select g.stimmkreisid, g.parteiname, g.gesamt_stimmen, g.gesamt_stimmen * 100.00 / a.sum from gesamt_stimmen_pro_partei_pro_stimmkreis_view g, anzahl_stimmen_pro_stimmkreis a
